...
import com.pji.project.models.Niveau;
...
public class EleveController implements WebMvcConfigurer{
	  ...
	  @Autowired
	  public ClassesRepository classeRepository;
	  ...
	  //@Valid removed from adherent  and BindingResult bindingResult from arguments // @ModelAttribute before mere pere elev
		public String addNewAdherent(@Valid Eleve eleve ,BindingResult bindingResult, Classes classe, Parent pere ,Parent mere)
	    {
